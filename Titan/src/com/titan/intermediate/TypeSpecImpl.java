package com.titan.intermediate;

import com.titan.intermediate.symtabimpl.Predefined;

import java.util.HashMap;

import static com.titan.intermediate.TypeFormImpl.SUBRANGE;
import static com.titan.intermediate.typeimpl.TypeKeyImpl.*;
    ...
    implements TypeSpec
{
    ...
    public TypeSpecImpl(String value)
    {
        ...
        indexType.setAttribute(TypeFormImpl.SUBRANGE.SUBRANGE_MIN_VALUE, 1);
        indexType.setAttribute(TypeFormImpl.SUBRANGE.SUBRANGE_MAX_VALUE, value.length());
